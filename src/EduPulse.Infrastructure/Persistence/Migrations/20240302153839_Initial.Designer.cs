...
namespace EduPulse.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240302153839_Initial")]
            ...
            modelBuilder.Entity("GroupEntityUserEntity", b =>
                {
                    ...
                    b.HasKey("GroupsId", "UsersId")
                        .HasName("pk_group_entity_user_entity");

                    b.HasIndex("UsersId")
                        .HasDatabaseName("ix_group_entity_user_entity_users_id");

                    b.ToTable("group_entity_user_entity", (string)null);
                });
            ...
            modelBuilder.Entity("GroupEntityUserEntity", b =>
                {
                    b.HasOne("EduPulse.Domain.Entities.GroupEntity", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_group_entity_user_entity_groups_groups_id");

                    b.HasOne("EduPulse.Domain.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_group_entity_user_entity_users_users_id");
                });
